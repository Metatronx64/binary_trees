 ...
 * @node: Pointer to the node to be stored in the linked list.
...
/**
 * _push - Pushes a node into the stack (linked list).
 * @node: Pointer to the node to be pushed into the stack.
...
/**
 * _pop - Pops a node from the stack (linked list).
 * @head: Pointer to the head node of the stack.
 */
