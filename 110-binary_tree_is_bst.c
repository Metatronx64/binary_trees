...
/**
 * check_sub_tree_Left - Checks if all nodes in the left subtree are smaller than a given value.
 * @node: Pointer to the node in the tree to verify the condition.
...
/**
 * check_sub_tree_Right - Checks if all nodes in the right subtree are bigger than a given value.
 * @node: Pointer to the node in the tree to verify the condition.
 ...
 * The process here is to first verify that the left node is smaller than the root,
 ...
 * @tree: Pointer to the node that points to the root of the tree to check.
